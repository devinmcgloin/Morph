...
// 	}
//
// 	valid, err := redis.Permissions(requestFrom, model.CanDelete, col)
// 	if err != nil {
// 		return rsp.Response{Code: http.StatusInternalServerError}
// 	}
// 	if !valid {
// 		return rsp.Response{Message: "User cannot delete collection.", Code: http.StatusUnauthorized}
// 	}
//
...
// }
//
// func DeleteCollection(requestFrom model.User, collectionRef model.Ref) rsp.Response {
